...
(11, 'Kalymnos, Greece', 'This photo was taken in August 2013, during my rock climbing trip in Kalymnos, Greece. The cave in the photo is called Grande Grotta (Great Cave) and it is a popular climbing spot among climbers.', 'Alexandre Franca', 'af_kalymnosgreece.jpg', 640, 480, 'Travel', 0, 0),
...
(19, 'Calm', 'One of those "calm before the storm" moments, literally. Interestingly enough, at that exact moment all wind turbines were standing still-there was no wind, no sound and no movement in miles; almost as if time had stopped.', 'Angel Paunchev', 'ap_calm.jpg', 640, 480, 'Weather', 0, 0),
...
(21, 'Sunset', 'The obligatory sunset photo. The colours and composition catch almost perfectly the calmness of a nice walk down a yacht port just after a beautiful sunset.', 'Angel Paunchev', 'ap_sunset.jpg', 640, 480, 'Travel', 0, 0),
(22, 'Tian Tian, Edinburgh Zoo', 'This is a picture of Tian Tian, one of the giant pandas in Edinburgh Zoo.', 'Anne-Marie Docherty', 'amd_tiantianedinburghzoo.jpg', 640, 480, 'Nature', 0, 0),
(23, 'Tibor, Edinburgh Zoo', 'This is a picture of Tibor, a sumatran tiger in Edinburgh Zoo', 'Anne-Marie Docherty', 'amd_tiboredinburghzoo.jpg', 640, 480, 'Nature', 0, 0),
(24, 'Chimpanzee, Edinburgh Zoo', 'This is picture of one of the chimpanzees within the Bugondo Trail situated within Edinburgh Zoo.', 'Anne-Marie Docherty', 'amd_chimpanzeeedinburghzoo.jpg', 640, 480, 'Nature', 0, 0),
(25, 'Ben Nevis', 'Foothill of Ben Nevis - highest peak in Britain. It is located close to Fort William in Highlands.', 'Aurelijus Vedrickas', 'av_bennevis.jpg', 640, 480, 'Travel', 0, 0),
(26, 'Conic Hill', 'Track to Conic Hill. Conic Hill rises above Balmaha village on the eastern shore of Loch Lomond.', 'Aurelijus Vedrickas', 'av_conichill.jpg', 480, 640, 'Travel', 0, 0),
(27, 'Oban', 'View of Oban bay from Douglas castle. On the left Scotland''s west coast, Oban town. Island of Kerrera on the right.', 'Aurelijus Vedrickas', 'av_oban.jpg', 640, 480, 'Travel', 0, 0),
...
(37, 'Labrador', 'My Labrador Biskit, enjoying a long walk around the countryside surrounding my village, Neilston, on a clear summers day.', 'Christopher Collins', 'cc_labrador.jpg', 640, 480, 'Nature', 0, 0),
(38, 'Thistle', 'I took this image with my phone while testing the macro mode. I was surprised to see how well it turned out. It shows the bee looking like a predator when actually it isn''t. ', 'Christopher Collins', 'cc_thistle.jpg', 640, 480, 'Nature', 0, 0),
(39, 'Statue Of Liberty', 'This was taken while in New York in September 2010. I was slightly disappointed in the statue as it actually isn''t as big as I thought it would be. Although it does stand dominant on it''s own island.', 'Christopher Collins', 'cc_statueofliberty.jpg', 480, 640, 'Travel', 0, 0),
(40, 'Glasgow Clouston Street 1985', 'Glasgow Clouston Street 1985 on a snowy day - picture taken from Flickr and under rights it says this image can be shared.', 'Christopher MacKinnon', 'cmack_glasgowcloustonstreet1985.jpg', 640, 480, 'Weather', 0, 0),
(41, 'Royal Staircase', 'A royal staircase leading upwards,hanging above is a chandelier and in the middle are some paintings', 'Christopher MacKinnon', 'cmack_royalstaircase.jpg', 4288, 2848, 'Travel', 0, 0),
(42, 'Ngon Ping Memorial', 'The Ngon Ping Memorial in Hong Kong - found in stockvault and had no copyright issues contained.', 'Christopher MacKinnon', 'cmack_ngonpingmemorial.jpg', 640, 480, 'Travel', 0, 0),
(43, 'Citizen M Hotel', 'A street view of Citizen M Hotel; a modern hotel located in Glasgow city centre.', 'Christopher Weir', 'cw_citizenmhotelglasgow.jpg', 640, 480, 'Travel', 0, 0),
(44, 'Kelvingrove Skatepark', 'Kelvingrove skatepark situated in Glasgow''s West End with Kelvingrove Art Gallery and Museum visible in the background.', 'Christopher Weir', 'cw_kelvingroveskatepark.jpg', 640, 480, 'Sports', 0, 0),
(45, 'Bearded Dragon', 'A young, female central bearded dragon perched on a small log inside its vivarium.', 'Christopher Weir', 'cw_beardeddragon.jpg', 640, 480, 'Nature', 0, 0),
...
(49, 'Brandenburg Gate', 'Brandenburg Gate, located in Berlin. One of the most well -known landmarks in Germany.', 'Dane McLaren', 'dmcl_brandenburggate.jpg', 640, 480, 'Travel', 0, 0),
...
(51, 'Berlin Cathedral', 'The Berlin Cathedral is located in the tourist area "Museum Island" and is a popular tourist attraction. Although referred to as a cathedral, it has never been used as a traditional cathedral as a it has never been the seat of a bishop.', 'Dane McLaren', 'dmcl_berlincathedral.jpg', 640, 480, 'Travel', 0, 0),
(52, 'Angel Of The North', 'The angel of the north is a sculpture, created by Antony Gormley and is found in Gateshead England.', 'Daniel Watson', 'dw_angelofthenorth.jpg', 631, 375, 'Travel', 0, 0),
(53, 'Beach, Scarborough', 'Picture of the beach at Scarborough, north Yorkshire, England', 'Daniel Watson', 'dw_beachscarborough.jpg', 640, 480, 'Travel', 0, 0),
(54, 'Tyne Bridge', 'Tyne bridge in Newcastle it connects new castle and Gateshead', 'Daniel Watson', 'dw_tynebridge.jpg', 640, 480, 'Travel', 0, 0),
(55, 'The Rogers Centre', 'The Toronto Blue Jays taking on the Kansas City Royals, the Blue Jays are batting whilst the Royals are pitching. The shot is taken inside the home of the Toronto Blue Jays, The Rogers Centre.', 'Daryn Ballantine', 'db_therogerscentre.jpg', 300, 300, 'Travel', 0, 0),
(56, 'CN Tower', 'Looking up at "the world''s tallest free-standing tower" which is the CN Tower, from the ground on a sunny afternoon.', 'Daryn Ballantine', 'db_cntower.jpg', 480, 640, 'Travel', 0, 0),
(57, 'Niagara Falls', 'Ascending on a lift looking over Niagara Falls one of the biggest tourist attractions in the whole of Canada.', 'Daryn Ballantine', 'db_niagarafalls.jpg', 640, 480, 'Travel', 0, 0),
(58, 'Rollercoaster, Blackpool Pleasure Beach', 'People upside down on the rollercoaster, Infusion, at the Blackpool Pleasure Beach.', 'David Stevenson', 'ds_rollercoasterblackpoolpleasurebeach.png', 640, 480, 'Travel', 0, 0),
(59, 'Three Wheeled Motorbike', 'Three wheeled motorbike with three seats at a motorbike show in Blackpool.', 'David Stevenson', 'ds_threewheeledmotorbike.png', 640, 480, 'Transport', 0, 0),
(60, 'Blackpool Tower', 'The Blackpool Tower in Blackpool also in the process of being renovated.', 'David Stevenson', 'ds_blackpooltower.png', 640, 480, 'Travel', 0, 0),
(61, 'Sunset, Largs', 'Sunset in Largs.', 'Dawn Stoddart', 'decs_sunsetlargs.jpg', 416, 308, 'Travel', 0, 0),
(62, 'Blizzard, Largs', 'Blizzard in Largs', 'Dawn Stoddart', 'decs_blizzardlargs.jpg', 416, 312, 'Weather', 0, 0),
(63, 'Holiday in Bulgaria', 'Holiday in Bulgaria', 'Dawn Stoddart', 'decs_holidayinbulgaria.jpg', 555, 312, 'Travel', 0, 0),
...
(67, 'Pinawalla Elephant Sanctuary, Sri Lanka', 'Bathing elephants in a river at Pinawalla Elephant Sanctuary, Sri Lanka', 'Gary Arbuckle', 'ga_pinawallaelephantsanctuarysrilanka.jpg', 640, 480, 'Nature', 0, 0),
(69, 'Forth Rail Bridge', 'Forth Rail Bridge over the river Forth,Scotland in winter', 'Gary Arbuckle', 'ga_forthrailbridge.jpg', 640, 480, 'Travel', 0, 0),
...
(71, 'Beach, Koh Samui, Thailand', 'A beautiful beach just behind the Samui Natien Resort in Koh Samui, Thailand. Looking out you can see the local fisherman boats sitting in the shallow water of the beach.', 'Geraldine Steele', 'gems_beachkohsamuithailand.jpg', 640, 480, 'Travel', 0, 0),
(72, 'Beach, Ang Thong National Marine Park', 'A beautiful beach at the Ang Thong National Marine Park in Koh Samui, Thailand. It looks out onto several islands in the park and offers many activities for tourists, such as canoeing and snorkelling. ', 'Geraldine Steele', 'gems_beachangthongnationalmarinepark.jpg', 640, 480, 'Travel', 0, 0),
(73, 'Canal, Amsterdam', 'This is an image of a Canal in Amsterdam Centre. The canals link together most of the streets and are populated with many pedal boats, boat tours, and houseboats you can rent to stay in on your holiday.', 'Gillian Cameron', 'gc_canalamsterdam.jpg', 480, 640, 'Travel', 0, 0),
(74, 'Jim Morrison''s Grave', 'Jim Morrison''s Grave in Pere Lachaise Cemetery, in Paris. This is the largest graveyard in Paris, and Oscar Wilde is also buried here.', 'Gillian Cameron', 'gc_jimmorrisonsgrave.jpg', 480, 640, 'Travel', 0, 0),
(75, 'Eiffel Tower', 'This is the Eiffel Tower in the centre of Paris. From the top platform the view stretches for 50 metres.', 'Gillian Cameron', 'gc_eiffeltower.jpg', 480, 640, 'Travel', 0, 0),
...
(84, 'By The Water', 'This photo was taken by my mother who gave me permission to use this. She cannot remember exactly where it was taken but it was taken up north in Scotland in June this year on the edge of a lake on a summers day.', 'Iain Sweeney', 'is_bythewater.jpg', 672, 507, 'Travel', 0, 0),
(85, 'Bell''s Bridge', 'Bell''s Bridge is a footbridge spanning the River Clyde in Glasgow connecting SECC with the Science Centre.', 'Jamie Couperwhite', 'jc_bellsbridge.jpg', 680, 480, 'Travel', 0, 0),
(86, 'Saltire Centre', 'The Saltire Centre a modern and stylish library and study area for Glasgow Caledonian University students.', 'Jamie Couperwhite', 'jc_saltirecentre.jpg', 640, 480, 'Travel', 0, 0),
(87, 'Piggy', 'A wee piggybank enjoying his natural habitat.', 'Jamie Couperwhite', 'jc_piggy.jpg', 640, 480, 'Nature', 0, 0),
(88, 'Safari, Kenya', 'This image is of Elephants in the wild which I seen whilst taking a safari trip in Kenya. The safari took place in the Tsavo East National Park, which is located in the city of Mombasa, Kenya. It''s one of the oldest and largest parks in Kenya. It''s home to many wild animals and most famously the big five, which include Elephants, Lions, Buffalos, leopard, rhinoceros. ', 'Kevin Githwe', 'kg_safarikenya.jpg', 640, 480, 'Travel', 0, 0),
...
(91, 'Temple Bar Dragon Boundary Mark', 'A photo of one of the dragon boundary marks of the City of London taken from a bus on a tour of London. This particular mark is the Temple Bar dragon and he differs from the other boundary marks as he is black (the others are silver) and he is gripping his shield with both front legs rather than one. He is standing on a tall patterned pillar on his two back legs and has his mouth open in a snarl which makes him fiercer looking than his silver counterparts.', 'Leanne Waton', 'lw_templebardragonboundarymark.jpg', 480, 640, 'Travel', 0, 0),
...
(96, 'Trencin, Slovakia', 'As one of the oldest Slovak towns, Trencin was built in a strategic position to allow a castle to be created on the hill top. Today it is an important centre of trade and economy, along with a rich culture.', 'Louis Cuthbert', 'lc_trencinslovakia.jpg', 640, 480, 'Travel', 0, 0),
...
(100, 'Victoria Square, Birmingham', 'Victoria Square in Birmingham, during the evening includes The River fountain, otherwise known as The Floozie in the Jacuzzi and the Council House.', 'Lucy Hadley', 'lh_victoriasquarebirmingham.jpg', 480, 640, 'Travel', 0, 0),
(101, 'Selfridges, Birmingham', 'Selfridges Department Store in Birmingham and part of the Bullring shopping centre at night.', 'Lucy Hadley', 'lh_selfridgesbirmingham.jpg', 480, 640, 'Travel', 0, 0),
(102, 'Birmingham Shopping Centre', 'Birmingham Shopping Centre, at night. The Bull symbolises the entrance to the city''s two main commercial areas known as The Bullring.', 'Lucy Hadley', 'lh_birminghamshoppingcentre.jpg', 480, 640, 'Travel', 0, 0),
...
(106, 'Dor Beetle', 'On holiday I went hillwalking near Charleston, Scotland. Along my travels I came across a "Dor Beetle", these types of beetle are very common, but the striking colour of blue/purple had me captivated the moment I saw it.', 'Martyn Gillett', 'mg_dorbeetle.jpg', 640, 480, 'Nature', 0, 0),
...
(113, 'London', 'I took this image on a trip to London to visit a friend. It was on a summer''s day when we were walking through a park next to the Palace of Westminister. It shows the British flag flying on the top with trees covering the foreground.', 'Rachel Queen', 'rq_london.jpg', 640, 480, 'Travel', 0, 0),
(114, 'Romania', 'This picture was taken up a mountain in Romania during the summer holidays. It shows a river running through the other mountains out of sight of the picture. There are trees in the foreground of the picture which are on the very edge of a ridge on the mountain, above a very steep slope down!', 'Rachel Queen', 'rq_romania.jpg', 640, 480, 'Travel', 0, 0),
(115, 'Blackpool Beach', 'An image of the recently completed improvement of Blackpool beach at tide in. Improvements began in early 2006 and finished November 2011, a 5 year project.', 'Robert Stevenson', 'rs_blackpoolbeach.jpg', 640, 480, 'Travel', 0, 0),
(116, 'Coral Island, Blackpool', 'This image is of Coral Island, an amusement arcade in Blackpool. Contains various attractions, slot machines, and holds regular prize bingo sessions.', 'Robert Stevenson', 'rs_coralislandblackpool.jpg', 640, 480, 'Travel', 0, 0),
(117, 'View From Blackpool Tower', 'This image was taken from the top of the Blackpool tower. It shows the promenade and south pier.', 'Robert Stevenson', 'rs_viewfromblackpooltower.jpg', 640, 480, 'Travel', 0, 0),
...
(122, 'Ibiza', 'The second image is a picture that shows the view from our hotel when me and my friends went to Ibiza in 2012. Unlike Ibiza''s party reputation, this image depicts a tranquil surrounding and a beautiful landscape.', 'Scott Crum', 'sc_ibiza.jpg', 416, 555, 'Travel', 0, 0),
(123, 'Celtic', 'The third image is a picture of the pre-match display, celebrating the 125th anniversary of Celtic Football Club - which the Green Brigade had organised -  at the Celtic v Barcelona match in the UEFA Champions League group stage. This was the 2012/2013 season, which saw Celtic win 2-1. The goals were scored by Victor Wanyama, Tony Watt and Lionel Messi.', 'Scott Crum', 'sc_celtic.jpg', 480, 640, 'Sports', 0, 0),
(124, 'Trevi Fountain', 'A photo looking onto the Trevi Fountain in Rome, Italy at night', 'Shawnee Henry', 'sh_trevifountain.jpeg', 640, 480, 'Travel', 0, 0),
(125, 'Colosseum', 'A photo taken from inside the Colosseum looking into the main arena on a summers day', 'Shawnee Henry', 'sh_colosseum.jpeg', 640, 480, 'Travel', 0, 0),
(126, 'River Tiber', 'A photo taken from on a bridge looking onto the River Tiber and the surrounding area.', 'Shawnee Henry', 'sh_rivertiber.jpeg', 640, 480, 'Travel', 0, 0),
(127, 'Budapest', 'During a wander around the city of Budapest, on the Buda side, my friend and I found a street filled with colourful homes leading to a grand building with a decorative roof. This picture was taken mid May 2013.', 'Sophie Bannerman', 'sb_budapest.jpg', 640, 480, 'Travel', 0, 0),
(128, 'Vienna', 'This image is a view over the Danube River in Vienna. At this point of the Danube, there''s an island in the middle that has a beach, a number of cafes and is a popular area to sunbathe. The modern buildings making up the background are part of the Donaustadt area.', 'Sophie Bannerman', 'sb_vienna.jpg', 640, 480, 'Travel', 0, 0),
(129, 'Durness', 'This was taken a few miles away from Durness on a secluded beach, Balnakeil Bay. The image focuses on the rock formation and untouched sand.', 'Sophie Bannerman', 'sb_durness.jpg', 640, 480, 'Travel', 0, 0),
(130, 'Monkeys, India', 'This photo was taken on a university trip to India, this trip was not only memorable it was also life changing.', 'Stacey Docherty', 'sd_monkeysindia.jpg', 640, 480, 'Nature', 0, 0),
(131, 'Dragonfly, India', 'This photo was also taken on a trip to India; this dragonfly was extremely beautiful.', 'Stacey Docherty', 'sd_dragonflyindia.jpg', 640, 480, 'Nature', 0, 0),
(132, 'Bird, India', 'This photo was also taken on a trip to India with the university. This bird was extremely inquisitive and this was a great photo opportunity.', 'Stacey Docherty', 'sd_birdindia.jpg', 640, 480, 'Nature', 0, 0),
...
(135, 'Can Of Irn Bru', 'This is simply just a photo that I took which I really admire. It is of a can of Irn Bru which is manufactured by A.G. Barr. It was first created in 1901 in Falkirk and since then it has expanded to become the most successful soft drink in Scotland and the 3rd most successful in the UK, behind Coca-Cola and Pepsi.', 'Stephen Mauchan', 'sm_canofirnbru.jpg', 640, 480, 'Food', 0, 0),
(136, 'The Capitol building, Washington DC', 'The Capitol building, Washington DC', 'Thomas McCarthy', 'tmcc_capitolbuildingwashingtondc.jpg', 640, 480, 'Travel', 0, 0),
(137, 'V1 Doodlebug, Smithsonian, Washington DC', 'This is a picture of a V1 "doodlebug" flying bomb from the Smithsonian Air and Space museum in Washington DC.', 'Thomas McCarthy', 'tmcc_v1doodlebugsmithsonianwashingtondc.jpg', 640, 480, 'Transport', 0, 0),

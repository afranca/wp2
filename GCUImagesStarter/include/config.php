<?php
// SITE_ROOT contains the full path to the GCUImages folder
...
define('LOG_ERRORS_FILE', 'c:\\GCUImages\\errors_log.txt'); // Windows
// define('LOG_ERRORS_FILE', '/home/username/GCUImages/errors.log'); // Linux
...
define('DB_USERNAME', 'imagesadmin');
define('DB_PASSWORD', 'imagesadmin');
define('DB_DATABASE', 'gcuimages');
define('PDO_DSN', 'mysql:host=' . DB_SERVER . ';dbname=' . DB_DATABASE);

// Server HTTP port (can omit if the default 80 is used)
define('HTTP_SERVER_PORT', '80');
/* Name of the virtual directory the site runs in, for example:
   '/gcuimages/' if the site runs at http://www.example.com/gcuimages/
   '/' if the site runs at http://www.example.com/ */
define('VIRTUAL_LOCATION', '/GCUImages/');

// Configure image lists display options
define('SHORT_IMAGE_DESCRIPTION_LENGTH', 15);
...
define('ADMIN_USERNAME', 'imagesadmin');
define('ADMIN_PASSWORD', 'imagesadmin');
?>
